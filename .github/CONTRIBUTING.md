...
4. [The release workflow](./workflows/release.yml) automatically tag a
   ...
   Pull Request.
5. Check the release workflow and verify the release. [![release](https://github.com/reviewdog/reviewdog/workflows/release/badge.svg)](https://github.com/TeamMonumenta/reviewdog/actions?query=workflow%3Arelease)
...
7. Check the release workflow and verify the release. [![release](https://github.com/reviewdog/reviewdog/workflows/release/badge.svg)](https://github.com/TeamMonumenta/reviewdog/actions?query=workflow%3Arelease)
