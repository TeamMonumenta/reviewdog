...
import (
	...
	"github.com/TeamMonumenta/reviewdog/service/commentutil"
)
...
func TestGitHubPullRequest_Post(t *testing.T) {
	...
	// https://github.com/TeamMonumenta/reviewdog/pull/2
	owner := "haya14busa"
	repo := "reviewdog"
	pr := 2
	...
	// https://github.com/TeamMonumenta/reviewdog/pull/2/files#diff-ed1d019a10f54464cfaeaf6a736b7d27L20
...
+++ b/reviewdog.go
@@ -10,18 +10,18 @@ import (
 	"github.com/TeamMonumenta/reviewdog/diff"
 )
