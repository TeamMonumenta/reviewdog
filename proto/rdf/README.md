...
much welcome. Please leave comments in Pull Request ([#629](https://github.com/TeamMonumenta/reviewdog/pull/629)),
in issue [#628](https://github.com/TeamMonumenta/reviewdog/issues/628) or
file [an issue](https://github.com/TeamMonumenta/reviewdog/issues).

The document and the actual definition are currently under the
https://github.com/TeamMonumenta/reviewdog repository, but we may create a separate
...
[reviewdog](https://github.com/TeamMonumenta/reviewdog) resolves the above problem
